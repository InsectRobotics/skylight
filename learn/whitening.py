...
def build_kernel(x, svd2ker, epsilon=10e-5):
    ...
    logger.debug('Creating the tranformation matrix...')
...
def transform(x, m=None, w=None, func=zca, epsilon=10e-5, load_filepath=None, save_filepath=None):
    """
