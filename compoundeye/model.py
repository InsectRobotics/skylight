...
if __name__ == "__main__":
    ...
    ommatidia = np.rad2deg(beeeye())
    print ommatidia.shape

    plt.plot(ommatidia[:, 1], ommatidia[:, 0], 'b.')
    plt.plot(np.rad2deg(as_1_2), np.rad2deg(es_1_2), 'b-')
    plt.plot(np.rad2deg(as_3_4), np.rad2deg(es_3_4), 'b-')
    plt.plot(np.rad2deg(as_1_2) - 360, np.rad2deg(es_1_2), 'b-')

    # plt.plot(-ommatidia[:, 1], ommatidia[:, 0], 'g.')
    # plt.plot(-np.rad2deg(as_1_2), np.rad2deg(es_1_2), 'g-')
    # plt.plot(-np.rad2deg(as_3_4), np.rad2deg(es_3_4), 'g-')
    # plt.plot(-np.rad2deg(as_1_2) + 360, np.rad2deg(es_1_2), 'g-')
